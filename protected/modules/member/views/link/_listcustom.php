<li id="studio-link-<?php echo $entry->id?>" class="cf">
	...
	<span class="menu">
		<?php echo YsaHtml::link('Edit', array('link/editCustom/' . $entry->id), array('class' => 'icon i_brush', 'title' => 'Edit Link Details')); ?>
		<?php echo YsaHtml::link('Delete', array('link/deleteCustom/' . $entry->id), array('class' => 'del icon i_x_alt', 'title' => 'Delete Link')); ?>
	</span>
	<span class="sort">
