	...
	<section class="box">
		<div class="box-title">
			...
			<div class="box-title-button">
				<?php echo YsaHtml::link('<span class="icon i_chat"></span>Send Push Notification', '/member/notification/new/recipient/'.$entry->id.'/type/client', array('class' => 'secondary iconed', 'id' => 'send-push-link')); ?>
