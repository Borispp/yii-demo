<div class="g12">
	...
	<p>
		<?php echo YsaHtml::link('Export to CSV', array('member/export'), array('class' => 'btn i_download icon')); ?>
		<?php echo YsaHtml::link('Add New', array('add'), array('class' => 'btn i_plus icon ysa fr')); ?>
		<?php echo YsaHtml::link('Send announcement', array('announcement/addtoall'), array('class' => 'btn i_mail icon ysa fr')); ?>
